...
public class Graph 
{
    public Node start;// Source Building
    public Node finish;//Destination Building

    /// <summary>
    /// The nodes.
    /// </summary>
    [SerializeField]
    protected List<Node> m_Nodes = new List<Node>();//Consists of all the nodes in the building
    ...
    /// <summary>
    ///  shortest path from the starting building to the ending building
    /// </summary>
    ...
    public Path GetShortestPath(Node start, Node end)
    {
        ...
        //Building ID value cannot be NULL for both the source and destination
        ...
        // If the start and end buildings are same node, we can return the start node
        if (start == end)
        {
